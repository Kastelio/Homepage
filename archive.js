...
const CAT_KO = {
    ...
    Etc: '기타', Enhancement: '강화', Event: '이벤트', Exchange: '거래소',
    Exploration: '탐험', Faction: '세력', Faith: '신앙', Family: '가문', Farm: '농장', Feudal: '영지',
    FieldBoss: '필드 보스', FirstPurchase: '첫 구매', Friend: '친구',
    Gacha: '가챠', GameSettings: '게임 설정', GachaProbability: '가챠 확률', GameTips: '게임 팁',
    ...
    Notice: '공지', Notification: '알림', NpcAffinity: '호감도', NumericInput: '숫자 입력', OfflinePlay: '오프라인 플레이',
    ...
    WebView: '웹뷰', Wiki: '백과사전', _Modding: '모딩', _PCCafe: 'PC방 이벤트', book: '책', equipment: '장비',
...
const GROUP_DEF = [
    ...
    ['Trade', '교환', ['Crafting','Decompose']],
    ['TerritoryGrowth', '영지 성장', ['Construction']],
    ['Accomplishment', '달성', ['Achievement','Trophy','Codex','Mission','Ranking','Quest']],
    ['AccountGrowthGroup', '계정 성장', ['AccountGrowth','CollectionGrowth']],
    ['Collect', '수집', ['Profile','Title_Badge','Cinematic','Dialogue','Story','Lore','Media','Memoir','Timeline','HeroLibrary','AdventureBook','book']],
