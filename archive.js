...
const CAT_KO = {
    ...
    Menu: '메뉴', MilestoneOffer: '마일스톤 상품',  Minigame: '미니게임', Mission: '미션',
    ...
    Reward: '보상',  Rune: '룬',
    Scan: '스캔',  Season: '시즌', SeasonPass: '시즌 패스', Settings: '게임 설정', BMShop: 'BM상점',
    Shortcut: '바로가기', SiegeBattle: '공성전', Simulation: '시뮬레이션', Skill: '스킬', SoulCore: '소울 코어',
    BMShopProductTypeConditional: '조건부 상품', BMShopDiscountCoupon: 'BM상점 할인 쿠폰', BMShopGuildDonation: '길드 기여 상품', BMShopBonusPurchaseCount: '구매 횟수 보너스 상품', BMShopProductTypeChoice: '선택형 상품', BMShopProductTypePeriod: '기간형 상품', BMShopProductTypeAttendance: '출석 상품', Stage: '스테이지', BMActivityCharge: '활동력 충전', StarterPack: '스타터 팩',
