...
const CAT_KO = {
    ...
    Reward: '보상',  Rune: '룬',
    Scan: '스캔',  Season: '시즌', SeasonPass: '시즌 패스', Settings: '게임 설정', Shop: '상점',
...
const GROUP_DEF = [
    ...
    ['Guide', '가이드', ['Tutorial','ActionTutorial','Guide','GuideMission','GameTips','DropInfo','Notification','Statistics','Wiki']],
