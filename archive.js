...
const GROUP_DEF = [
    ...
    ['BM', 'BM', ['BMShop','BMActivityCharge','SpecialOffer','BMShopProductTypeStepup','ConditionalOffer','MilestoneOffer','FirstPurchase','StarterPack','Subscription','SeasonPass','Pass','Gacha','GachaProbability','GuardianSummon','Purchase','VIP']],
