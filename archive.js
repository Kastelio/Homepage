...
const CAT_KO = {
    ...
    Death: '사망', Decision: '결정', Decompose: '분해',
    ...
    Storage: '창고', StrategicMeeting: '전략 회의', Subscription: '구독', Synthesis: '합성',
    Tarot: '타로', TeamFormation: '편성', Timeline: '타임라인', Title: '타이틀',
    CharacterTitle: '칭호', TradingPort: '교역항', Training: '훈련', Trophy: '도전과제', Trait: '특성', TraitPoint: '특성 포인트',
...
const GROUP_DEF = [
    ...
    ['Collect', '수집', ['Profile','CharacterTitle','Cinematic','Lore','Media','Memoir','Timeline','HeroLibrary','AdventureBook','book']],
