...
const CAT_KO = {
    ...
    Gacha: '가챠', GameSettings: '게임 설정', GachaProbability: '가챠 확률', GameTips: '게임 팁', Gift: '선물',
...
const GROUP_DEF = [
    ...
    ['Collect', '수집', ['Profile','Title_Badge','Emote','Gift','Cinematic','Dialogue','Story','Lore','Media','Memoir','Timeline','HeroLibrary','AdventureBook','book']],
