...
const CAT_KO = {
    ...
    Encyclopedia: '도감', Etc: '기타', Enhancement: '강화', Event: '이벤트', Exchange: '거래소',
...
const GROUP_DEF = [
    ...
    ['Collect', '수집', ['Encyclopedia','Gallery','Profile','Title_Badge','Emote','Gift','Cinematic','Dialogue','Story','Lore','Media','Memoir','Timeline','HeroLibrary','AdventureBook','book']],
