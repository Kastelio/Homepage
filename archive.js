...
const CAT_KO = {
    ...
    CharacterSkill: '캐릭터 스킬', Chat: '채팅', Cinematic: '시네마틱', Codex: '도감', Class: '클래스',
    ...
    FieldBoss: '필드 보스', FirstPurchase: '첫 구매', Friend: '친구',
    Gacha: '가챠', GameSettings: '게임 설정', GachaProbability: '가챠 확률', Gallery: '갤러리', GameTips: '게임 팁', Gift: '선물',
    GrowthEvent: '성장 이벤트', GrowthGuide: '성장 가이드', GrowthCollection: '수집', Guardian: '수호자', GuardianPromotion: '수호자 승급',
    GuardianSummon: '수호자 소환', Guide: '가이드', GuideMission: '가이드 미션', Guild: '길드', GuildAuction: '길드 경매', 
    Heritage: '유산', Hero: '영웅', HeroLevel: '영웅 레벨', HeroLibrary: '영웅 도서관',
    HeroRating: '영웅 평가', Housing: '하우징', HUDEdit: 'HUD 편집', InGameComputer: '인게임 컴퓨터', IdleReward: '방치형 보상',
    ...
    Title_Badge: '칭호', TradingPort: '교역항', Training: '훈련', Trophy: '도전과제', Trait: '특성', TraitPoint: '특성 포인트',
    TravelLevel: '여행 레벨', Tutorial: '튜토리얼', VIP: 'VIP', WarArchive: '전쟁 기록', WeaponMastery: '무기 숙련',
    WebView: '웹뷰', _Modding: '모딩', _PCCafe: 'PC방 이벤트', book: '책', equipment: '장비',
...
const GROUP_DEF = [
    ...
    ['Accomplishment', '달성', ['Achievement','Trophy','Codex','Mission','Journal','Ranking','Quest','Challenge','Statistics','Attendance']],
    ['AccountGrowthGroup', '계정 성장', ['AccountGrowth']],
    ...
    ['Guide', '가이드', ['Tutorial','ActionTutorial','Guide','GuideMission','GameTips','GrowthGuide','DropInfo','Notification']],
    ...
    ['Event', '이벤트', ['Event','InGameEvent','PreRegistration','Minigame','_PCCafe']],
