...
const CAT_KO = {
    ...
    SpecialOffer: '특별 상품', Stage: '스테이지', BMActivityCharge: '활동력 충전', StarterPack: '스타터 팩',
    Statistics: '통계형 가이드', Stats: '캐릭터 스탯', StatFilter: '스탯 필터', StepUpOffer: '스텝업 상품',
...
const GROUP_DEF = [
    ...
    ['BM', 'BM', ['BMShop','BMActivityCharge','SpecialOffer','StepUpOffer','ConditionalOffer','MilestoneOffer','FirstPurchase','StarterPack','Subscription','SeasonPass','Pass','Gacha','GachaProbability','GuardianSummon','Purchase','VIP']],
